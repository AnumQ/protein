...
#endif
#ifdef CLUSTALW_DLL // abc.dll source code will define this macro before including this header
#define CLUSTALW_API __declspec( dllexport )
#else
#define CLUSTALW_API __declspec( dllimport )
#endif
