...
DistanceAndSimilarity::DistanceAndSimilarity()
{
    //ctor
}

void DistanceAndSimilarity::createSimilarityMatrixCodes( vector<ProteinSequence> p )
{
...
void DistanceAndSimilarity::createSimilarityMatrixColours( vector<ProteinSequence> p )
{
    double maxD = getMaxDistance();
    //cout << "MAXD: " << maxD << endl;
    double currentValue;
...
void DistanceAndSimilarity::createDistanceTableColours( vector<ProteinSequence> p )
{
...
void DistanceAndSimilarity::createDistanceTableCodes( vector<ProteinSequence> p )
{
...
void DistanceAndSimilarity::setMaxDistance( double num )
{
    maxDistance = num;
}

double DistanceAndSimilarity::getMaxDistance()
{
    return maxDistance;
}

string DistanceAndSimilarity::countSeqs(vector<ProteinSequence> p )
{
    ScoreMatrix convert;
    int countSeq = 0;
    for( size_t i = 0; i < p.size(); i++ )
...
void DistanceAndSimilarity::writeHorizontalFirstLine( vector<ProteinSequence> p, ofstream& oFile, string tab )
{
    ScoreMatrix convert;
