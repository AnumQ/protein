...
void VerticalColumn::getUserInput()
{
...
void VerticalColumn::setUserInput(string s )
{
    InputValue = s;
}

string VerticalColumn::getInputValue()
{
    return InputValue;
}

void VerticalColumn::generateVerticalColumnComposition(vector<ProteinSequence> p )
{
    createColumns(p);
    processColumns();
    ...
    createVerticalColumnCodes(input);
    createVerticalColumnColour(input);
}

void VerticalColumn::createColumns( vector<ProteinSequence> p )
{
    string tab = "\t";
    string lbreak = "\n";
...
vector<AlignmentColumn> VerticalColumn::getColumns()
{
    return AllColumns;
}

void VerticalColumn::processColumns()
{
    Columns = getColumns();
...
void VerticalColumn::createVerticalColumnCodes(string input)
{
    string tab = "\t";
    string lbreak = "\n";
    outFile = new FileCreator();
...
void VerticalColumn::createVerticalColumnColour(string input)
{
    string tab = "\t";
    string lbreak = "\n";
    outFile = new FileCreator();
