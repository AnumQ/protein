...
{
    cout << "   Please enter the minimum percentage of the distribution of Amino Acids (vertically): ";
    cin >> UserInput;
...
void VerticalPosition::createColumns( vector<ProteinSequence> p )
{
    ...
    cout << "size of AllColumns " << AllColumns.size() << endl;
...
void VerticalPosition::createVerticalPosition()
{
    string tab = "\t";
    string lbreak = "\n";
    outFile = new FileCreator();
...
void VerticalPosition::createVerticalPositionColour()
{
    string tab = "\t";
    string lbreak = "\n";
    outFile = new FileCreator();
